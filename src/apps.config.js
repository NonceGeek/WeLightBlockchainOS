...
import OtherApps from './components/apps/otherApps';
...
const apps = [
    ...
    },
    {
        id: "other",
        title: "Other Apps",
        icon: './themes/Yaru/apps/other-apps.png',
        disabled: false,
        favourite: true,
...
const urls = {
    ...
    appUrl: {
        ...
        // otherApps url
        otherApps: 'https://r8jmm3f9xe.feishu.cn/docs/doccn7NAgCeMZlz9AWzNc17Wxwh',
    },
    staticUrl: {
